...
def parce_output():
    ...
    if len(output) > 6:
        ...
        data_to_check['rrqm/s']   = output[1]
        data_to_check['wrqm/s']   = output[2]
        data_to_check['r/s']      = output[3]
        data_to_check['w/s']      = output[4]
        data_to_check['rMB/s']    = output[5]
        data_to_check['wMB/s']    = output[6]
        data_to_check['avgrq-sz'] = output[7]
        data_to_check['avgqu-sz'] = output[8]
